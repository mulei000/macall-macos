...
enum SwitcherSupport {
    ...
    static func sessionSourceItem(frontmostPID: pid_t?,
                                  ...
                                  items: [VSSwitcherItem]) -> VSSwitcherItem? {
    ...
    static func appPID(forFrontmost frontmostPID: pid_t, items: [VSSwitcherItem]) -> pid_t {
    ...
    static func appGroups(items: [VSSwitcherItem]) -> [SwitcherAppGroup] {
        var seen: Set<pid_t> = []
    ...
    static func nextAppSelectionIndex(items: [VSSwitcherItem],
                                      selectedIndex: Int,
                                      delta: Int,
    ...
    static func nextWindowSelectionIndexWithinApp(items: [VSSwitcherItem],
                                                  selectedIndex: Int,
                                                  delta: Int) -> Int {
