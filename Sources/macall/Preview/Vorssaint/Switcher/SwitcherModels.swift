...
struct VSSwitcherItem: Identifiable, Equatable {
    let id: String
    let title: String
    let appName: String
    ...
    func withMinimized(_ minimized: Bool) -> VSSwitcherItem {
        VSSwitcherItem(id: id,
                     title: title,
                     appName: appName,
                     pid: pid,
    ...
    static func window(id: CGWindowID, title: String, appName: String, pid: pid_t,
                       ...
                       isFullscreen: Bool = false, frame: CGRect) -> VSSwitcherItem {
        VSSwitcherItem(id: "w:\(id)", title: title, appName: appName,
    ...
    static func appOnly(appName: String, pid: pid_t) -> VSSwitcherItem {
        VSSwitcherItem(id: "a:\(pid)", title: appName, appName: appName,
